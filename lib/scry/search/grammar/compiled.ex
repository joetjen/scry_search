  ...
  (
    ...
    def lex_token__KW_SEARCH(input0) do
      with {:ok, t0, rest0} <- lex_expr__0(input0),
           ...
           {:ok, t5, rest5} <- lex_expr__5(rest4) do
    ...
    def lex_expr__28(input0) do
      with {:ok, t0, rest0} <- lex_expr__29(input0), {:ok, t1, rest1} <- lex_expr__30(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__27(input) do
      Tokenizer.opt_char(&lex_expr__28/1, input)
    end
    ...
    def lex_expr__35(input0) do
      with {:ok, t0, rest0} <- lex_expr__36(input0),
           ...
           {:ok, t5, rest5} <- lex_expr__41(rest4) do
        {:ok, t0 <> t1 <> t2 <> t3 <> t4 <> t5, rest5}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__33(input) do
      Tokenizer.first_char_match([&lex_expr__34/1, &lex_expr__35/1], input)
    end
    ...
    def lex_expr__17(input0) do
      with {:ok, t0, rest0} <- lex_expr__18(input0),
           {:ok, t1, rest1} <- lex_expr__19(rest0),
           {:ok, t2, rest2} <- lex_expr__20(rest1),
           {:ok, t3, rest3} <- lex_expr__21(rest2),
           {:ok, t4, rest4} <- lex_expr__22(rest3),
           {:ok, t5, rest5} <- lex_expr__23(rest4),
           {:ok, t6, rest6} <- lex_expr__24(rest5),
           {:ok, t7, rest7} <- lex_expr__25(rest6),
           {:ok, t8, rest8} <- lex_expr__26(rest7),
           {:ok, t9, rest9} <- lex_expr__27(rest8),
    ...
    def lex_expr__16(input) do
      Tokenizer.opt_char(&lex_expr__17/1, input)
    end

    def lex_token__DATE(input0) do
      with {:ok, t0, rest0} <- lex_expr__6(input0),
           {:ok, t1, rest1} <- lex_expr__7(rest0),
           {:ok, t2, rest2} <- lex_expr__8(rest1),
           {:ok, t3, rest3} <- lex_expr__9(rest2),
           {:ok, t4, rest4} <- lex_expr__10(rest3),
           {:ok, t5, rest5} <- lex_expr__11(rest4),
           {:ok, t6, rest6} <- lex_expr__12(rest5),
           {:ok, t7, rest7} <- lex_expr__13(rest6),
           {:ok, t8, rest8} <- lex_expr__14(rest7),
           {:ok, t9, rest9} <- lex_expr__15(rest8),
           {:ok, t10, rest10} <- lex_expr__16(rest9) do
        {:ok, t0 <> t1 <> t2 <> t3 <> t4 <> t5 <> t6 <> t7 <> t8 <> t9 <> t10, rest10}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__42(input) do
      Tokenizer.first_char_match([&lex_expr__43/1, &lex_expr__44/1], input)
    end

    def lex_token__TRIVIA(input) do
      Tokenizer.star_char(&lex_expr__42/1, input)
    end
    ...
    def lex_expr__54(input0) do
      with {:ok, t0, rest0} <- lex_expr__55(input0),
    ...
    def lex_expr__53(input) do
      Tokenizer.not_pred_char(&lex_expr__54/1, input)
    end
    ...
    def lex_expr__52(input0) do
      with {:ok, t0, rest0} <- lex_expr__53(input0), {:ok, t1, rest1} <- lex_expr__58(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__49(input) do
      Tokenizer.star_char(&lex_expr__50/1, input)
    end
    ...
    def lex_token__MULTILINE_STRING(input0) do
      with {:ok, t0, rest0} <- lex_expr__45(input0),
    ...
    def lex_expr__68(input) do
      Tokenizer.first_char_match([&lex_expr__69/1, &lex_expr__70/1], input)
    end
    ...
    def lex_token__IDENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__64(input0), {:ok, t1, rest1} <- lex_expr__67(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__76(input) do
      Tokenizer.first_char_match([&lex_expr__77/1, &lex_expr__78/1], input)
    end

    def lex_expr__75(input) do
      Tokenizer.star_char(&lex_expr__76/1, input)
    end
    ...
    def lex_expr__82(input) do
      Tokenizer.not_pred_char(&lex_expr__83/1, input)
    end
    ...
    def lex_expr__81(input0) do
      with {:ok, t0, rest0} <- lex_expr__82(input0), {:ok, t1, rest1} <- lex_expr__84(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__80(input) do
      Tokenizer.star_char(&lex_expr__81/1, input)
    end
    ...
    def lex_expr__88(input) do
      Tokenizer.first_char_match([&lex_expr__89/1, &lex_expr__90/1], input)
    end
    ...
    def lex_expr__92(input) do
      Tokenizer.first_char_match([&lex_expr__93/1, &lex_expr__94/1], input)
    end

    def lex_expr__91(input) do
      Tokenizer.star_char(&lex_expr__92/1, input)
    end
    ...
    def lex_token__ESCAPED_IDENT(input0) do
      with {:ok, t0, rest0} <- lex_expr__87(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__91(rest1),
    ...
    def lex_expr__112(input) do
      Tokenizer.not_pred_char(&lex_expr__113/1, input)
    end
    ...
    def lex_expr__111(input0) do
      with {:ok, t0, rest0} <- lex_expr__112(input0), {:ok, t1, rest1} <- lex_expr__114(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__106(input0) do
      with {:ok, t0, rest0} <- lex_expr__107(input0),
           ...
           {:ok, t2, rest2} <- lex_expr__115(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_token__STRING(input) do
      Tokenizer.first_char_match([&lex_expr__96/1, &lex_expr__106/1], input)
    end
    ...
    def lex_expr__116(input) do
      Tokenizer.plus_char(&lex_expr__117/1, input)
    end
    ...
    def lex_expr__121(input) do
      Tokenizer.plus_char(&lex_expr__122/1, input)
    end

    def lex_expr__119(input0) do
      with {:ok, t0, rest0} <- lex_expr__120(input0), {:ok, t1, rest1} <- lex_expr__121(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__118(input) do
      Tokenizer.opt_char(&lex_expr__119/1, input)
    end
    ...
    def lex_expr__132(input) do
      Tokenizer.first_char_match([&lex_expr__133/1, &lex_expr__134/1], input)
    end
    ...
    def lex_expr__135(input) do
      Tokenizer.star_char(&lex_expr__136/1, input)
    end

    def lex_token__ATOM(input0) do
      with {:ok, t0, rest0} <- lex_expr__131(input0),
           {:ok, t1, rest1} <- lex_expr__132(rest0),
    ...
    def lex_token__NOT_EQ(input0) do
      with {:ok, t0, rest0} <- lex_expr__141(input0),
           {:ok, t1, rest1} <- lex_expr__142(rest0),
           {:ok, t2, rest2} <- lex_expr__143(rest1),
           {:ok, t3, rest3} <- lex_expr__144(rest2) do
        {:ok, t0 <> t1 <> t2 <> t3, rest3}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__152(input0) do
      with {:ok, t0, rest0} <- lex_expr__153(input0),
           ...
           {:ok, t3, rest3} <- lex_expr__156(rest2),
           {:ok, t4, rest4} <- lex_expr__157(rest3) do
    ...
    def lex_token__LE(input0) do
      with {:ok, t0, rest0} <- lex_expr__161(input0), {:ok, t1, rest1} <- lex_expr__162(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__173(input) do
      Tokenizer.plus_char(&lex_expr__174/1, input)
    end

    def lex_expr__171(input0) do
      with {:ok, t0, rest0} <- lex_expr__172(input0), {:ok, t1, rest1} <- lex_expr__173(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def lex_expr__170(input) do
      Tokenizer.opt_char(&lex_expr__171/1, input)
    end
    ...
    def lex_expr__190(input) do
      Tokenizer.plus_char(&lex_expr__191/1, input)
    end

    def lex_expr__187(input0) do
      with {:ok, t0, rest0} <- lex_expr__188(input0),
           {:ok, t1, rest1} <- lex_expr__189(rest0),
    ...
    def lex_expr__195(input) do
      Tokenizer.plus_char(&lex_expr__196/1, input)
    end

    def lex_expr__192(input0) do
      with {:ok, t0, rest0} <- lex_expr__193(input0),
           {:ok, t1, rest1} <- lex_expr__194(rest0),
           {:ok, t2, rest2} <- lex_expr__195(rest1) do
        {:ok, t0 <> t1 <> t2, rest2}
      else
        :fail -> :fail
      end
    ...
    def lex_token__RADIX(input) do
      Tokenizer.first_char_match([&lex_expr__187/1, &lex_expr__192/1, &lex_expr__197/1], input)
    end
    ...
    def lex_token__GE(input0) do
      with {:ok, t0, rest0} <- lex_expr__202(input0), {:ok, t1, rest1} <- lex_expr__203(rest0) do
        {:ok, t0 <> t1, rest1}
      else
        :fail -> :fail
      end
    ...
    def parse_expr__20(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__21/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__base_type(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__14/4, &parse_expr__15/4, &parse_expr__16/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__field_name(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__41/4, &parse_expr__42/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__50(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__51(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__53(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__49(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__50/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__47(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__48(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__49(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__46(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__47/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_expr(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__43(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__46(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__55(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__56/4, &parse_expr__57/4], stream, pos, ref_stack, context)
    end

    def parse_expr__54(stream, pos, ref_stack, context) do
      case (&parse_expr__55/4).(stream, pos, ref_stack, context) do
    ...
    def parse_expr__58(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__59/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__mult_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__54(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__58(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__60(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__67(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__68/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__61(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__67(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__69(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__71(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__75(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__76/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__disjunction(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__72(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__75(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__92(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__93(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__96(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__97(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__99(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__comparison_ep1e(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__91/4, &parse_expr__92/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__frame_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__100(stream, pos, ref_stack, context),
           ...
           {:ok, pos6, ref6, cap5} <- parse_expr__107(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__109(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__110(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__112(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__with_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__113/4, &parse_expr__114/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__call_with_path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__119(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__123(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__125(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__129(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__130/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__141(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__142/4, &parse_expr__143/4, &parse_expr__144/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__154(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__155/4, &parse_expr__156/4], stream, pos, ref_stack, context)
    end

    def parse_expr__153(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__154/4, stream, pos, ref_stack, context)
    end

    def parse_expr__152(stream, pos, ref_stack, context) do
      case (&parse_expr__153/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_rule__window_call(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__157(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__161(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__163(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__204(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__205/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__field_body_item(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__192/4, &parse_expr__200/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__group_by_rollup(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__210(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__216(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__217(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__219(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__243(stream, pos, ref_stack, context) do
      case (&parse_expr__244/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__239(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__240(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__243(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__246(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__248(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__combinator_tail(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__239/4, &parse_expr__249/4, &parse_expr__254/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__type_param(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__259(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__265(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__277(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__278(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__280(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__276(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__277/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__270(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__271(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__276(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__269(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__270/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__type_field(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__285(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__288(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__289(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__291(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__317(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__318(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__320(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__316(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__317/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__314(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__315(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__316(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__326(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__327/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__324(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__325(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__326(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__337(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__338(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__340(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__336(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__337/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__334(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__335(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__336(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__document(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__313(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__333(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__341(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__343(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__344(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__346(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__372(stream, pos, ref_stack, context) do
      case (&parse_expr__373/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__386(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__387/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__order_by_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__388(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__391(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__392(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__394(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__type_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__395/4, &parse_expr__396/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__with_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__397(stream, pos, ref_stack, context),
           ...
           {:ok, pos6, ref6, cap5} <- parse_expr__404(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__406(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__select(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__407(stream, pos, ref_stack, context),
           ...
           {:ok, pos22, ref22, cap21} <- parse_expr__446(stream, pos21, ref21, context),
           {:ok, pos23, ref23, cap22} <- parse_expr__448(stream, pos22, ref22, context),
           {:ok, pos24, ref24, cap23} <- parse_expr__449(stream, pos23, ref23, context),
           {:ok, pos25, ref25, cap24} <- parse_expr__451(stream, pos24, ref24, context) do
        {:ok, pos25, ref25,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__rational(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__452(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__453(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__455(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__456(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__458(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__460(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__461/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__465(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__466/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__463(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__464(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__465(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__462(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__463/4, stream, pos, ref_stack, context)
    end

    def parse_rule__expression(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__459(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__460(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__462(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__477(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__478(stream, pos, ref_stack, context),
    ...
    def parse_expr__476(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__477/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__474(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__475(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__476(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__486(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__487(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__488(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__490(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__path(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__481(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__484(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__fragment_decl(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__504(stream, pos, ref_stack, context),
           ...
           {:ok, pos5, ref5, cap4} <- parse_expr__510(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__511(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__513(stream, pos6, ref6, context),
           {:ok, pos8, ref8, cap7} <- parse_expr__514(stream, pos7, ref7, context),
           {:ok, pos9, ref9, cap8} <- parse_expr__516(stream, pos8, ref8, context) do
        {:ok, pos9, ref9,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__partition_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__517(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__520(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__521(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__523(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__group_by_cube(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__524(stream, pos, ref_stack, context),
           ...
           {:ok, pos4, ref4, cap3} <- parse_expr__528(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__530(stream, pos4, ref4, context),
           {:ok, pos6, ref6, cap5} <- parse_expr__531(stream, pos5, ref5, context),
           {:ok, pos7, ref7, cap6} <- parse_expr__533(stream, pos6, ref6, context) do
        {:ok, pos7, ref7,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__539(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__540/4, &parse_expr__541/4], stream, pos, ref_stack, context)
    end

    def parse_expr__538(stream, pos, ref_stack, context) do
      case (&parse_expr__539/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
    ...
    def parse_expr__547(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__548/4, &parse_expr__549/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__frame_bound(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__534/4, &parse_expr__542/4, &parse_expr__550/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__body_item(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__555/4, &parse_expr__556/4, &parse_expr__557/4, &parse_expr__558/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_expr__560(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__561/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__negation(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__559(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__564(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__570(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__571(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__572(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__574(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__579(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__580(stream, pos, ref_stack, context),
    ...
    def parse_expr__576(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__577(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__579(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__575(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__576/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__569(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__570(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__575(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__568(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__569/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__591(stream, pos, ref_stack, context) do
      Parser.star(&parse_expr__592/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__when_expr(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__584(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__591(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__593(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__594(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__596(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__fragment_or_comment(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__597/4, &parse_expr__598/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__607(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__608(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__611(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__612(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__614(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__615(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__616(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__619(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__620(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__622(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__623(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__624(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__627(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__628(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__630(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__631(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__632(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__633(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__635(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__636(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__638(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_expr__648(stream, pos, ref_stack, context) do
      case (&parse_expr__649/4).(stream, pos, ref_stack, context) do
        {:ok, new_pos, new_ref_stack, inner_caps} ->
          text = Parser.concat_text(stream, pos, new_pos)
          {:ok, new_pos, new_ref_stack, Parser.merge_captures(inner_caps, op: {:text, text})}
    ...
    def parse_rule__additive_tail(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__648(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__652(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__654(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__662(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__663(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__665(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__661(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__662/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__659(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__660(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__661(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__658(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__659/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__limit_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__666(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__669(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__670(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__672(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__type_kind(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__690(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__691(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__693(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__699(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__700(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__703(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__697(stream, pos, ref_stack, context) do
      Parser.opt(&parse_expr__698/4, stream, pos, ref_stack, context)
    end
    ...
    def parse_expr__727(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__728(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__729(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__731(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__724(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__725(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__727(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_expr__723(stream, pos, ref_stack, context) do
      Parser.rep(&parse_expr__724/4, 0, :infinity, stream, pos, ref_stack, context)
    end

    def parse_expr__717(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__718(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__723(stream, pos1, ref1, context) do
        {:ok, pos2, ref2, Parser.merge_captures(cap0, cap1)}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__type_field_list(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__713(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__716(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__call_arg(stream, pos, ref_stack, context) do
      Parser.try_alts([&parse_expr__732/4, &parse_expr__737/4], stream, pos, ref_stack, context)
    end
    ...
    def parse_rule__in_lhs(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__738/4, &parse_expr__739/4, &parse_expr__740/4, &parse_expr__741/4],
        stream,
        pos,
        ref_stack,
        context
    ...
    def parse_rule__list_type(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__742(stream, pos, ref_stack, context),
           ...
           {:ok, pos3, ref3, cap2} <- parse_expr__745(stream, pos2, ref2, context),
           {:ok, pos4, ref4, cap3} <- parse_expr__746(stream, pos3, ref3, context),
           {:ok, pos5, ref5, cap4} <- parse_expr__748(stream, pos4, ref4, context) do
        {:ok, pos5, ref5,
         Parser.merge_captures(
           cap0,
           Parser.merge_captures(
    ...
    def parse_rule__having_clause(stream, pos, ref_stack, context) do
      with {:ok, pos1, ref1, cap0} <- parse_expr__749(stream, pos, ref_stack, context),
           {:ok, pos2, ref2, cap1} <- parse_expr__750(stream, pos1, ref1, context),
           {:ok, pos3, ref3, cap2} <- parse_expr__752(stream, pos2, ref2, context) do
        {:ok, pos3, ref3, Parser.merge_captures(cap0, Parser.merge_captures(cap1, cap2))}
      else
        _fail -> :fail
      end
    ...
    def parse_rule__predicate_lhs(stream, pos, ref_stack, context) do
      Parser.try_alts(
        [&parse_expr__753/4, &parse_expr__754/4, &parse_expr__755/4],
        stream,
        pos,
        ref_stack,
        context
